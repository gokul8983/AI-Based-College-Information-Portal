    ...
    <div class="wrapper">
        <div class="login-pannel" style="">
            <div class="inner_logo">
                <img src="images/logochat.png" width="320px" height="" />
            </div>
            <div class="col-xs-6 login-inner" style="">
                ...
                <div class="block col-xs-12" style="padding: 10px 0 0 0px; border: none; background-color: #F2F2F2;">
                    <div class="form-group">
                        <div class="col-xs-10">
                            <asp:TextBox ID="txtUsername" placeholder="Username" class="form-control input-lg"
                                runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator2" runat="server"
                                ControlToValidate="txtUsername" ForeColor="Red">Enter User Name</asp:RequiredFieldValidator>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-10">
                            <div class="">
                                ...
                                <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                    ControlToValidate="txtPassword" ForeColor="Red">Enter Password</asp:RequiredFieldValidator>
                            </div>
                            <div style="clear: both; height: 20px;">
                            </div>
    ...
    <div class="wrapper">
        <div style="border-top: 1px solid #E8E8E8;">
            <div class="login-menu">
                <a href="index.html" class="btn btn-primary2">Home</a> &nbsp;
                  <asp:Button ID="btnStudentLogin" runat="server" CssClass="btn btn-primary2" Text="Student Login"
                                    OnClick="btnStudentLogin_Click" CausesValidation="false" />
                
               <%-- <div class="right_label2">
