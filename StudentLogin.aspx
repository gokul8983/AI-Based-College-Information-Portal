        ...
        <div class="login-pannel" style="">
            ...
            <div class="col-xs-6 login-inner" style="">
                ...
                <div class="block col-xs-12" style="padding: 10px 0 0 0px; border: none; background-color: #F2F2F2;">
                    <div class="form-group">
                        <div class="col-xs-10">
                            <asp:TextBox ID="txtUsername" placeholder="Email Id" class="form-control input-lg"
                                runat="server">
                            </asp:TextBox>
                    ...
                    <div class="form-group">
                        <div class="col-xs-10">
                            ...
                            <div class="col-xs-3" style="float: right;">
                             ...
                             Don't have Account <asp:LinkButton ID="btnStudentRegistration" runat="server"  Text="Register"
                                    OnClick="btnStudentRegistration_Click" CausesValidation="false" />
                        </div>
                    </div>
            ...
            <div class="login-menu">
                 <div class="label_signin">
                   <a href="index.html" class="btn btn-primary2">Home</a> &nbsp;
                    <asp:Button ID="btnAdminLogin" runat="server" CssClass="btn btn-primary2" Text="Admin Login"
                                    OnClick="btnAdminLogin_Click" CausesValidation="false" />
                </div>
